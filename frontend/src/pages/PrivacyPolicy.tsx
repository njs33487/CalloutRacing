          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                CalloutRacing ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application and website (collectively, the "Service").
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                ...
                <li>Profile information (bio, location, car details)</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                ...
                <li><strong>Public profiles:</strong> Your profile information may be visible to other users as part of the social networking features</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                We retain your personal information for as long as necessary to provide our Service and fulfill the purposes outlined in this Privacy Policy. You may request deletion of your account and associated data at any time.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                ...
                <li><strong>Location services:</strong> Control location data collection through device settings</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                Email: privacy@calloutracing.com<br />
