...
try:
    ...
    print("Error: Could not import core.models. Please ensure Django is properly configured.")
    sys.exit(1)
...
def populate_production_data():
    """Populate production database with comprehensive data"""
    print("🚀 Starting production data population...")
    
    # 1. Create/Update Admin User
    print("👤 Creating admin user...")
    admin_user, created = DjangoUser.objects.get_or_create(
        username='admin',
        defaults={
    ...
    print(f"👥 Users: {DjangoUser.objects.count()}")
    ...
    print("="*50)
    print("\n🔗 Database URL: https://postgres-production-d788.up.railway.app/")
    print("✅ Data successfully populated to production database!")
